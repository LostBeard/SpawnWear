...
- 🚧 **Phase 4** Settings + apps. Settings screen live (brightness, sleep, live IMU motion); BLE/WiFi toggles next.
- ⏭ **Phases 5-9** Clock, Audio, AI Assistant (flagship), OTA + SD-card apps, Activity.
