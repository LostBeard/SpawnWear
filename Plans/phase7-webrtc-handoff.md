...
7. **Watch-side WebRTC stack (Stack B).** ✅ **RESOLVED 2026-05-05: libdatachannel + mbedtls** integrated into the LostBeard nf-interpreter fork, exposed as a managed primitive through nanoCLR. See [`Plans/phase7-firmware-stub.md`](phase7-firmware-stub.md) §"WebRTC peer integration" for the integration plan.
